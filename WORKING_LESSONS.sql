-- ✅ WORKING LESSON INSERTION SCRIPT - CONSTRAINTS FIXED
...
-- Insert lessons with correct lesson_type values
...
SELECT 'SUCCESS: All lessons added with correct constraint values' as message,
