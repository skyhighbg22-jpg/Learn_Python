/*
  # PyLearn String and File Operations Lessons - Fixed SQL Script
...
-- String Operations Lessons (10 lessons) - PROPERLY ESCAPED
...
('70000000-0000-0000-0000-000000000002', 'String Stripping and Cleaning', 'Remove unwanted characters and whitespace', 'beginner', 18, 2,
 (SELECT id FROM sections WHERE path = 'string-operations'),
 '[{"type": "text", "content": "Cleaning strings is essential for data processing and user input handling."}, {"type": "text", "content": "strip() removes leading/trailing whitespace. replace() substitutes characters."}, {"type": "code", "question": "Clean messy user input", "starterCode": "def clean_input(text):\\n    # Remove extra spaces and punctuation\\n    pass", "solution": "def clean_input(text):\\n    cleaned = text.strip()\\n    cleaned = \\" \\".join(cleaned.split())\\n    cleaned = cleaned.replace(\\",\\" , \\"\\").replace(\\".\\" , \\"\\").replace(\\"!\\" , \\"\\")\\n    return cleaned"}]',
 'coding', 15),
...
('70000000-0000-0000-0000-000000000004', 'Finding and Replacing', 'Search and substitute in strings', 'beginner', 20, 4,
 (SELECT id FROM sections WHERE path = 'string-operations'),
 '[{"type": "text", "content": "Python provides methods to find substrings and replace content. find() returns index or -1, replace() substitutes all occurrences."}, {"type": "code", "question": "Text search and replace utility', "starterCode": "def text_processor(text, search, replace_with):\\n    # Your code here\\n    pass", "solution": "def text_processor(text, search, replace_with):\\n    count = text.count(search)\\n    replaced_text = text.replace(search, replace_with)\\n    first_pos = text.find(search)\\n    return {\\"original\\": text, \\"count\\": count, \\"first_position\\": first_pos, \\"replaced\\": replaced_text}"}]',
 'coding', 18),

('70000000-0000-0000-0000-000000000005', 'Splitting and Joining', 'Break and combine strings', 'intermediate', 22, 5,
 (SELECT id FROM sections WHERE path = 'string-operations'),
 '[{"type": "text", "content": "split() breaks strings into lists based on a delimiter. join() combines list elements into a string."}, {"type": "code", "question": "Process a sentence into words", "starterCode": "sentence = \\"Python is a powerful programming language\\"\\n# Your code here", "solution": "sentence = \\"Python is a powerful programming language\\"\\nwords = sentence.split()\\nprint(f\\"Words: {words}\\")\\nprint(f\\"Word count: {len(words)}\\")"}]',
 'coding', 15),
...
('70000000-0000-0000-0000-000000000007', 'String Slicing', 'Extract substrings efficiently', 'intermediate', 28, 7,
 (SELECT id FROM sections WHERE path = 'string-operations'),
 '[{"type": "text", "content": "String slicing extracts portions using [start:end:step] syntax. Negative indices count from the end."}, {"type": "code", "question": "Extract information from string', "starterCode": "data = \\"Python_3.9.0_Stable\\"\\n# Your code here", "solution": "data = \\"Python_3.9.0_Stable\\"\\nprint(f\\"First 6 chars: {data[:6]}\\")\\nprint(f\\"Last 7 chars: {data[-7:]}\\")\\nprint(f\\"Reverse: {data[::-1]}\\")"}]',
 'coding', 18),

('70000000-0000-0000-0000-000000000008', 'String Formatting', 'Advanced string techniques', 'intermediate', 30, 8,
 (SELECT id FROM sections WHERE path = 'string-operations'),
 '[{"type": "text", "content": "Modern string formatting with f-strings and .format() method. f-strings are available in Python 3.6+."}, {"type": "code", "question": "Create formatted output', "starterCode": "name = \\"Alice\\"\\nage = 30\\n# Your code here", "solution": "name = \\"Alice\\"\\nage = 30\\n# f-string method\\nformatted_f = f\\"Name: {name}, Age: {age}\\"\\nprint(formatted_f)"}]',
 'coding', 22),

('70000000-0000-0000-0000-000000000009', 'Regular Expressions', 'Pattern matching in strings', 'advanced', 35, 9,
 (SELECT id FROM sections WHERE path = 'string-operations'),
 '[{"type": "text", "content": "Regular expressions provide powerful pattern matching capabilities. Import re module."}, {"type": "code", "question": "Extract phone numbers from text', "starterCode": "import re\\ntext = \\"Contact us at 555-1234\\"\\n# Your code here", "solution": "import re\\ntext = \\"Contact us at 555-1234\\"\\npattern = r\\\\b\\\\d{3}-\\\\d{3}-\\\\d{4}\\\\b\\nphones = re.findall(pattern, text)\\nprint(f\\"Phone Numbers: {phones}\\")"}]',
 'coding', 25),

('70000000-0000-0000-0000-000000000010', 'Text Processing Project', 'Real-world string manipulation', 'intermediate', 40, 10,
 (SELECT id FROM sections WHERE path = 'string-operations'),
 '[{"type": "text", "content": "Apply string operations to build a practical text processing tool. Build a word frequency analyzer."}, {"type": "code", "question": "Build word frequency analyzer', "starterCode": "import re\\nfrom collections import Counter\\ndef analyze_text_file(filename):\\n    # Your code here\\n    pass", "solution": "import re\\nfrom collections import Counter\\ndef analyze_text_file(filename):\\n    with open(filename, r, encoding=utf-8) as f:\\n        text = f.read().lower()\\n    words = re.findall(r\\\\b\\\\w+\\\\b, text)\\n    word_freq = Counter(words)\\n    return {\\"total_words\\": len(words), \\"unique_words\\": len(word_freq), \\"most_common\\": word_freq.most_common(5)}"}]',
 'project', 30)
ON CONFLICT (id) DO NOTHING;

-- File Operations Lessons (10 lessons) - PROPERLY ESCAPED
INSERT INTO lessons (id, title, description, difficulty, xp_reward, order_index, section_id, content, lesson_type, estimated_minutes) VALUES
...
('80000000-0000-0000-0000-000000000001', 'Reading Text Files', 'Learn how to read data from text files', 'beginner', 15, 1,
 ...
 '[{"type": "text", "content": "Reading files is essential for working with data. Python provides simple ways to read text files."}, {"type": "text", "content": "Use with statement for automatic file closing. read() reads entire file, readlines() returns list."}, {"type": "code", "question": "Read a file and count lines', "starterCode": "def count_lines(filename):\\n    # Read file and count lines\\n    pass", "solution": "def count_lines(filename):\\n    with open(filename, r) as file:\\n        lines = file.readlines()\\n        return len(lines)"}]',
 'coding', 15),
...
('80000000-0000-0000-0000-000000000004', 'Directory Operations', 'Working with directories and folder structures', 'intermediate', 22, 4,
 (SELECT id FROM sections WHERE path = 'file-operations'),
 '[{"type": "text", "content": "Directories help organize files. Python provides tools for directory management with os and os.path modules."}, {"type": "code", "question": "Create a project structure generator', "starterCode": "import os\\ndef create_project_structure(project_name, folders):\\n    # Create project with given folders\\n    pass", "solution": "import os\\ndef create_project_structure(project_name, folders):\\n    os.makedirs(project_name, exist_ok=True)\\n    for folder in folders:\\n        folder_path = os.path.join(project_name, folder)\\n        os.makedirs(folder_path, exist_ok=True)\\n    return f\\"Project {project_name} created successfully!\\""}]',
 'coding', 22),
...
('80000000-0000-0000-0000-000000000007', 'Context Managers for File Handling', 'Using with statements for robust file operations', 'intermediate', 30, 7,
 (SELECT id FROM sections WHERE path = 'file-operations'),
 '[{"type": "text", "content": "Context managers (with statements) ensure proper resource cleanup and exception safety."}, {"type": "code", "question": "Create custom context manager for file processing', "starterCode": "class FileProcessor:\\n    def __enter__(self):\\n        # Open file and return self\\n        pass\\n    def __exit__(self, exc_type, exc_val, exc_tb):\\n        # Close file and handle exceptions\\n        pass", "solution": "class FileProcessor:\\n    def __init__(self, filename, mode=r):\\n        self.filename = filename\\n        self.mode = mode\\n        self.file = None\\n    def __enter__(self):\\n        self.file = open(self.filename, self.mode)\\n        return self.file\\n    def __exit__(self, exc_type, exc_val, exc_tb):\\n        if self.file:\\n            self.file.close()\\n        return False"}]',
 'coding', 30),
...
('80000000-0000-0000-0000-000000000008', 'Error Handling in File Operations', 'Handling file-related exceptions gracefully', 'intermediate', 32, 8,
 (SELECT id FROM sections WHERE path = 'file-operations'),
 '[{"type": "text", "content": "File operations can fail for many reasons. Proper error handling is crucial for robust applications."}, {"type": "code", "question": "Create robust file reader with error handling', "starterCode": "def safe_read_file(filename, max_retries=3):\\n    # Read file with retry logic and error handling\\n    pass", "solution": "import os\\nimport time\\ndef safe_read_file(filename, max_retries=3):\\n    for attempt in range(max_retries):\\n        try:\\n            if not os.path.exists(filename):\\n                return {\\"error\\": f\\"File {filename} does not exist\\"}\\n            with open(filename, r, encoding=utf-8) as file:\\n                content = file.read()\\n                return {\\"success\\": True, \\"content\\": content, \\"size\\": len(content)}\\n        except Exception as e:\\n            if attempt < max_retries - 1:\\n                time.sleep(1)\\n                continue\\n            else:\\n                return {\\"error\\": f\\"Failed: {str(e)}\\"}\\n    return {\\"error\\": f\\"Failed after {max_retries} attempts\\"}"}]',
 'coding', 32),
...
SELECT 'String Operations Lessons Added' as metric, COUNT(*) as count
FROM lessons
WHERE section_id = (SELECT id FROM sections WHERE path = 'string-operations');

SELECT 'File Operations Lessons Added' as metric, COUNT(*) as count
FROM lessons
WHERE section_id = (SELECT id FROM sections WHERE path = 'file-operations');

SELECT 'Total New Lessons Added' as metric, COUNT(*) as count
FROM lessons
