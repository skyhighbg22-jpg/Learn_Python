-- Add String and File Operations Lessons - PROPERLY ESCAPED
...
-- Summary
SELECT
  'Lessons Added Successfully' as status,
  ...
  (SELECT COUNT(*) FROM lessons WHERE id LIKE '7%' OR id LIKE '8%') as total_new_lessons;