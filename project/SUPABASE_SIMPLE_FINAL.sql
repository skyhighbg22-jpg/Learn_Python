-- Add String and File Operations Lessons - Simple Version
...
BEGIN
    ...
    IF string_section_id IS NOT NULL AND file_section_id IS NOT NULL THEN
        ...
        ('70000000-0000-0000-0000-000000000007', 'String Slicing', 'Extract substrings', 'intermediate', 28, 7, string_section_id, '[{"type": "text", "content": "Use [start:end] syntax for slicing."}, {"type": "code", "question": "Extract from string", "starterCode": "data = \"Python_3.9\"\\n# Your code here", "solution": "print(data[:6])\\nprint(data[-2:])"}]', 'code', 18),
        ...
        ('80000000-0000-0000-0000-000000000006', 'File Copying', 'Copy files safely', 'intermediate', 28, 6, file_section_id, '[{"type": "text", "content": "Use shutil for file operations."}, {"type": "code", "question": "Backup file', "starterCode": "import shutil\\ndef backup(src, dst):\\n    pass", "solution": "shutil.copy2(src, dst)\\nreturn \"Backup complete\""}]', 'code', 28),
